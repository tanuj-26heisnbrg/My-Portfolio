    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row justify-center items-stretch gap-6 px-6 md:px-12 lg:px-24 mb-[10px]">
        ...
        <motion.section
          initial={{ opacity: 0, y: 80 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ type: 'spring', stiffness: 40, damping: 25, duration: 1.2 }}
          viewport={{ once: true, amount: 0.2 }}
        ...
        >
          ...
          <ul className="list-disc list-inside space-y-2 font-poppins flex-grow">
            ...
            <li>
              ...
              <a
                className="underline hover:text-violet-700 dark:hover:text-violet-600 transition-colors duration-300"
      ...
      <div className="flex flex-col lg:flex-row justify-center items-stretch gap-6 px-6 md:px-12 lg:px-24 mb-[10px]">
        ...
        >
          ...
          <ul className="list-disc list-inside space-y-2 font-poppins  flex-grow">
            ...
            <li>
              Getting to the CP level of{' '}
              <a className="underline" href="https://en.wikipedia.org/wiki/Gennady_Korotkevich">
                Gennady Korotkevich
              </a>
            </li>
